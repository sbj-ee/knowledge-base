...
*   **`scripts/`**: Executable scripts for performing specific tasks.
    ...
    *   `sync_iosxr_interfaces.py`: **(DEPRECATED)** Legacy IOS-XR interface sync (abbreviated names). Use `Cisco_Stuff/scripts/netbox/sync_iosxr_interfaces.py` instead.
...
# DEPRECATED — see Cisco_Stuff/scripts/netbox/sync_iosxr_interfaces.py
